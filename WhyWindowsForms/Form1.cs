...
namespace WhyWindowsForms
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button22.Image = global::WhyWindowsForms.Properties.Resources.beam;
            ...
            this.tableLayoutPanel3.Size = new System.Drawing.Size(300, 48);
            ...
            this.button21.Text = "柱";
            this.toolTip1.SetToolTip(this.button21, "外框柱");
            this.button21.UseVisualStyleBackColor = false;
            // 
            // button19
            // 
            this.button19.Image = global::WhyWindowsForms.Properties.Resources.up_arrow;
            ...
            // button20
            // 
            this.button20.Image = global::WhyWindowsForms.Properties.Resources.down_arrow;
            ...
            // button18
            // 
            this.button18.Image = global::WhyWindowsForms.Properties.Resources.city_buildings;
            ...
            this.button15.Image = global::WhyWindowsForms.Properties.Resources.add;
            ...
            this.button16.Image = global::WhyWindowsForms.Properties.Resources.delete;
            ...
            this.button17.Image = global::WhyWindowsForms.Properties.Resources.check;
            ...
            this.button6.Image = global::WhyWindowsForms.Properties.Resources.add;
            ...
            this.button7.Image = global::WhyWindowsForms.Properties.Resources.delete;
            ...
            this.button8.Image = global::WhyWindowsForms.Properties.Resources.check;
            ...
            this.button5.Image = global::WhyWindowsForms.Properties.Resources.inface;
            ...
            this.button4.Image = global::WhyWindowsForms.Properties.Resources.outface;
            ...
            this.button14.Image = global::WhyWindowsForms.Properties.Resources._6;
            this.button14.Location = new System.Drawing.Point(254, 3);
            ...
            this.button9.Image = global::WhyWindowsForms.Properties.Resources._11;
            ...
            this.button10.Image = global::WhyWindowsForms.Properties.Resources._2;
            this.button10.Location = new System.Drawing.Point(54, 3);
            ...
            this.button13.Image = global::WhyWindowsForms.Properties.Resources._5;
            this.button13.Location = new System.Drawing.Point(204, 3);
            ...
            this.button11.Image = global::WhyWindowsForms.Properties.Resources._3;
            this.button11.Location = new System.Drawing.Point(104, 3);
            ...
            this.button12.Image = global::WhyWindowsForms.Properties.Resources._4;
            ...
            this.button1.Image = global::WhyWindowsForms.Properties.Resources.add;
            ...
            this.button2.Image = global::WhyWindowsForms.Properties.Resources.delete;
            ...
            this.button3.Image = global::WhyWindowsForms.Properties.Resources.check;
        ...
        private void generateStructure()
        {
            ...
            for (int floor = 0; floor < height.Count; floor++)
            {
                ...
                {
                    //RhinoDoc.ActiveDoc.Objects.Select(RhinoDoc.ActiveDoc.Objects.AddLine(new Line(pout[i], pout[i + 1])),true);
                ...
                //RhinoDoc.ActiveDoc.Objects.AddLine(new Line(pout[0], pout[pout.Count - 1]));
                ...
                for (int i = 0; i < pout.Count; i++)
                {
                    ...
                    if (pout_x >= pin_x_min && pout_x <= pin_x_max + tolerance && pout_y >= pin_y_max - tolerance)
                    {
                        ...
                        //RhinoDoc.ActiveDoc.Objects.AddLine(new Line(new Point3d(pout_x, pout_y, pout_z), new Point3d(pout_x, pin_y_max, pout_z)));
                    }
                    else if (pout_x <= pin_x_min && pout_y <= pin_y_max + tolerance && pout_y >= pin_y_min - tolerance)
                    {
                        ...
                        //RhinoDoc.ActiveDoc.Objects.AddLine(new Line(new Point3d(pout_x, pout_y, pout_z), new Point3d(pin_x_min, pout_y, pout_z)));
                    }
                    else if (pout_x >= pin_x_min - tolerance && pout_x <= pin_x_max + tolerance && pout_y <= pin_y_min)
                    {
                        ...
                        //RhinoDoc.ActiveDoc.Objects.AddLine(new Line(new Point3d(pout_x, pout_y, pout_z), new Point3d(pout_x, pin_y_min, pout_z)));
                    }
                    else if (pout_x >= pin_x_max && pout_y >= pin_y_min - tolerance && pout_y <= pin_y_max + tolerance)
                    {
                        ...
                        //RhinoDoc.ActiveDoc.Objects.AddLine(new Line(new Point3d(pout_x, pout_y, pout_z), new Point3d(pin_x_max, pout_y, pout_z)));
                    }
                    else if (pout_x > pin_x_max && pout_y > pin_y_max)
                    {
                        ...
                        //RhinoDoc.ActiveDoc.Objects.AddLine(new Line(new Point3d(pout_x, pout_y, pout_z), new Point3d(pin_x_max, pin_y_max, pout_z)));
                    }
                    ...
                    else if (pout_x < pin_x_min && pout_y > pin_y_max)
                    {
                        ...
                        //RhinoDoc.ActiveDoc.Objects.AddLine(new Line(new Point3d(pout_x, pout_y, pout_z), new Point3d(pin_x_min, pin_y_max, pout_z)));
                    }
                    ...
                    else if (pout_x < pin_x_min && pout_y < pin_y_min)
                    {
                        ...
                        //RhinoDoc.ActiveDoc.Objects.AddLine(new Line(new Point3d(pout_x, pout_y, pout_z), new Point3d(pin_x_min, pin_y_min, pout_z)));
                    }
                    ...
                    else if (pout_x > pin_x_max && pout_y < pin_y_min)
                    {
                        ...
                        //RhinoDoc.ActiveDoc.Objects.AddLine(new Line(new Point3d(pout_x, pout_y, pout_z), new Point3d(pin_x_max, pin_y_min, pout_z)));
                    }
            ...
            for (int i = 0; i < pout_all.Count - 1; i++)
            {
                for (int j = 0; j < pout_all[0].Count; j++)
                {
                    ...
                    //RhinoDoc.ActiveDoc.Objects.AddLine(new Line(pout_all[i][j], pout_all[i + 1][j]));
                }
            }
            //腰部桁架
            if (waist.Count > 0)
        ...
        {
            foreach (var i in column.Branches)
            {
                foreach (var j in i)
                {
            ...
            foreach (var i in beam1.Branches)
            {
                foreach (var j in i)
                {
                    RhinoDoc.ActiveDoc.Objects.AddLine(j);
            ...
            foreach (var i in beam2.Branches)
            {
                foreach (var j in i)
                {
                    RhinoDoc.ActiveDoc.Objects.AddLine(j);
            ...
            foreach (var i in wall.Branches)
            {
                foreach (var j in i)
                {
                    RhinoDoc.ActiveDoc.Objects.AddLine(j);
            ...
            foreach (var i in brace1.Branches)
            {
                foreach (var j in i)
                {
                    RhinoDoc.ActiveDoc.Objects.AddLine(j);
            ...
            foreach (var i in brace2.Branches)
            {
                foreach (var j in i)
                {
                    RhinoDoc.ActiveDoc.Objects.AddLine(j);
