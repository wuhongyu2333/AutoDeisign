...
namespace WhyRhinoPlugin
{
    ...
    ///</summary>
    public class WhyRhinoPlugin : Rhino.PlugIns.RenderPlugIn
    {
        public WhyRhinoPlugin()
        {
            Instance = this;
        }

        ///<summary>Gets the only instance of the WhyRhinoPlugin plug-in.</summary>
        public static WhyRhinoPlugin Instance { get; private set; }
        ...
        {
            throw new NotImplementedException("Render is not implemented in the WhyRhinoPlugin.WhyRhinoPlugin class.");
        }
        ...
        {
            throw new NotImplementedException("RenderWindow is not implemented by the WhyRhinoPlugin.WhyRhinoPlugin class.");
        }
